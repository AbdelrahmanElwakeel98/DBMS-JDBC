...
public class DropTable implements Command {
	...
	public Object execute() {
		...
		if (dir.exists()) {
			File file1 = new File (path + databaseName + System.getProperty("file.separator") + tableName + ".xml");
			File file2 = new File (path + databaseName + System.getProperty("file.separator") + tableName + ".DTD");
